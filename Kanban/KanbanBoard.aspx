...
#contentBox
{
	...
	margin-right:0px;
      ...
      #analysis ul{ background-color:#F8CD4E;}
      #construction ul { background-color:#82E0AA;}
      #acceptance ul { background-color:#EC7063;}
      #backlog ul {background-color:#FF9A35;}
      #Done ul { background-color:#7BABDF;}
      .titlecontent {
