    ...
    $(document).ready(function () {
        ...
        $('span[id*="ff66"]').text('');
            ...
            if ($("select[id*=formfield10] option:selected").text() == "Yes") {
                ...
                $("select[id*='formfield29_ctl00_Lookup']").val("1");
        ...
        $("select[id*=formfield2_]").change(function () {
            if ($("select[id*=formfield2_] option:selected").text() == "Build") {
                ...
                $('#NoAssetID').hide();
                $("input[id*=ff4_]").prop("disabled", false);
                $("input[id*=ff4_]").val("");
                $("input[id*=ff5_]").val("");
        ...
        $("select[id*=ffield2_]").change(function () {
            if ($("select[id*=ffield2_] option:selected").text() == "No") {
                $("input[id*=ff4_]").val("NA");
                $("input[id*=ff5_]").val("NA");
                $("select[id*=formfield19_]").val("No Rating");
                $("select[id*=formfield5_]").val("NA");
                $("select[id*=formfield6_]").val("NA");
                $("select[id*=ff10_]").val("NA");
                $("select[id*=ff7_]").val("Other");
                $("select[id*=ff17_]").val("NA");
        ...
        $('#Ag').hide();
        $("select[id*=ff39_]").change(function () {
            
            if ($("select[id*=ff39_] option:selected").text() == "Agile") {
        ...
        $("input[id*=fieldAscore]").change(function () {
            var numbers = /^[0-9]+$/;
//            alert($("input[id*=fieldAscore]").val());
        ...
        $('#DeltaPlaceHolderPageTitleInTitleArea').text("DTM Form - SDLC V5");
        ...
        $("select[id*=formfield2_ctl00_DropDownChoice]").change(function () {
            if (($("select[id*=formfield2_ctl00_DropDownChoice] option:selected").text() == "Retire") ||
                ...
                $("select[id*=formfield10]").val('No');
                $("select[id*=formfield10]").attr("disabled", "disabled");
                ...
                $("select[id*=formfield10]").attr("disabled", false);
                $("select[id*=formfield22]").val('Yes');
                $("select[id*=formfield22]").attr("disabled", "disabled");
                $("select[id*=formfield23]").val('Yes');
                $("select[id*=formfield23]").attr("disabled", "disabled");
        ...
        function onQuerySucceededCMDB() {
            ...
            while (listItemEnumerator.moveNext()) {
               ...
               // waitDialog.close(0);
               // alert("SOX-"+ objListItem.get_item('SOX_x0020_Relevance'));
        ...
        function AddListItem() {
            ...
            var PMB = SP.FieldUserValue.fromUser($('span[id*="ff65_new_TopSpan_i"]').attr('sid'));
            
            newItem.set_item('PMB', PMB);
            var PMT = SP.FieldUserValue.fromUser($('span[id*="ff66_new_TopSpan_i"]').attr('sid'));
