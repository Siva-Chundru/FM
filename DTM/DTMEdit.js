    ...
    function disablecontrols() {
        ...
        if (usertype == "pqo" || ((createdby == currentuser) || (pmbusiness == currentuser) || (pmtechnology == currentuser))) {
            if (pqosubmit == "Yes") {
                $("input[id*=formfield]").attr("disabled", "disabled");
                $("input[id*=ff]").attr("disabled", "disabled");
                $("select[id*=formfield]").attr("disabled", "disabled");
    ...
    function AddListItem() {
        waitDialog = SP.UI.ModalDialog.showWaitScreenWithNoClose("Calculating DTM Results", "Please wait...", 300, 900);
        ...
        oListItem.set_item('Title', $("input[id*='ff1']").val());
        oListItem.set_item('Asset_x0020_Criticality', $("select[id*=formfield19] option:selected").text());
        oListItem.set_item('Asset_x0020_ID_x0023_', $("input[id*='ff4']").val());
        oListItem.set_item('Asset_x0020_Name', $("input[id*='ff5']").val());
        oListItem.set_item('Asset_x0020_Rider', $("select[id*=formfield3] option:selected").text());
        oListItem.set_item('Change_x0020_Type', $("select[id*=formfield2_ctl00_DropDownChoice] option:selected").text());
        oListItem.set_item('EBFQ1', $("select[id*=formfield22_ctl00_DropDownChoice] option:selected").text());
        oListItem.set_item('EBFQ2', $("select[id*=formfield23_ctl00_DropDownChoice] option:selected").text());
        oListItem.set_item('Buy_x002f_Hold_x002f_Sell', $("select[id*=ff7] option:selected").text());
        oListItem.set_item('Change_x0020_Release', $("input[id*='ff8']").val());
        oListItem.set_item('Financial_x0020_Reporting_x0020_', $("select[id*=ff10] option:selected").text());
        oListItem.set_item('Information_x0020_Classification', $("select[id*=formfield6] option:selected").text());
        oListItem.set_item('Infrastructure_x0020_System_x002', $("select[id*=formfield4] option:selected").text());
        oListItem.set_item('MHA', $("select[id*=formfield7] option:selected").text());
        oListItem.set_item('Utility', $("select[id*=formfield8] option:selected").text());
        oListItem.set_item('NPI', $("select[id*=formfield5] option:selected").text());
        oListItem.set_item('PAM_x0020_ID_x0020__x0023_', $("input[id*='ff15']").val());
        //oListItem.set_item('PQO_x0020_ID', $("input[id*='formfield9']").val());
        oListItem.set_item('SOX_x0020_Relevant', $("select[id*=ff17] option:selected").text());
        oListItem.set_item('Will_x0020_there_x0020_be_x0020_', $("select[id*=formfield10] option:selected").text());
        oListItem.set_item('Release_x0020_Methodology', $("select[id*=ff39] option:selected").text());
        oListItem.set_item('Other_x0020_Assets', $("input[id*=ff78]").val());
        var rid = new Date($("input[id*=ff61]").val());
        oListItem.set_item('RID', rid);
        var dd = new Date($("input[id*=ff62]").val());
        oListItem.set_item('DD', dd);
        oListItem.set_item('NoAssetID', $("select[id*=ffield2_] option:selected").text());
        oListItem.set_item('AgileAssessment', $("input[id*=fieldAg]").val());
        oListItem.set_item('AScore', $("input[id*=fieldAscore]").val());



        var si = new SP.FieldLookupValue();
        si.set_lookupId($("select[id*=formfield29_ctl00_Lookup] option:selected").val());
        oListItem.set_item('SI_x0020_Name', si);
        oListItem.set_item('Program', $("input[id*=ff64]").val());

        var PMB = SP.FieldUserValue.fromUser($("div[id*=ff65]").text());  
  		oListItem.set_item('PMB', PMB);
        var PMT = SP.FieldUserValue.fromUser($("div[id*=ff66]").text());  
  		oListItem.set_item('PMT', PMT);


        // Save GB engagements to item
        for (i = 0; i < 13; i++) {
            oListItem.set_item(GB[i][0], GB[i][1]);
        }

        //Save GB Questions to item

        oListItem.set_item('SourceCode', $("select[id*=formfield11] option:selected").text());
        oListItem.set_item('AppCode', $("select[id*=formfield12] option:selected").text());
        oListItem.set_item('Mainframe', $("select[id*=formfield13] option:selected").text());
        oListItem.set_item('Dataelements', $("select[id*=formfield14] option:selected").text());
        oListItem.set_item('thirdparty', $("select[id*=ff83] option:selected").text());
        oListItem.set_item('Definition', $("select[id*=ff84] option:selected").text());
        oListItem.set_item('CMStandard', $("select[id*=ff85] option:selected").text());
        oListItem.set_item('changes', $("select[id*=ff86] option:selected").text());
        oListItem.set_item('Business', $("select[id*=ff87] option:selected").text());
        oListItem.set_item('sensitive', $("select[id*=ff88] option:selected").text());

        oListItem.set_item('SingleFamily', $("select[id*=ff90] option:selected").text());
        oListItem.set_item('effortchange', $("select[id*=ff91] option:selected").text());
        oListItem.set_item('Dispose', $("select[id*=ff92] option:selected").text());
        oListItem.set_item('disposeinformation', $("select[id*=ff93] option:selected").text());
        oListItem.set_item('disposeorphaned', $("select[id*=ff94] option:selected").text());


        // Update Submit to pqo and status column
        oListItem.set_item('Submit_x0020_to_x0020_PQO', $("select[id*=SubmitPQO] option:selected").text());
        if (pqosubmit == "Yes") {
            oListItem.set_item('DTM_x0020_Status', "Submitted to PQO");
            // alert("Submitted to PQO");
        }
        if (pqosubmit == "Yes" && usertype == "pqo") {
        ...
        oListItem.set_item('Sampled_x0020_Out', $("select[id*=Sampled] option:selected").text());
        oListItem.set_item('Opted_x0020_In_x002d_Sampling', $("select[id*=Opted] option:selected").text());
        oListItem.set_item('RTF_x0020_Stability_x0020_Score', $("input[id*=RTF]").val());
        oListItem.set_item('Smapling_x0020_Comments', $("textarea[id*=Comments]").text());
        ...
        function onQuerySucceeded() {
            //	     alert("Item updated successfully at newItem_ID:" + dtmid);
            //			     dtmid = oListItem.get_id(); 
    ...
    function CreateDeliverables(dtmid) {
        ...
        camlQuery.set_viewXml('<View><Query><Where><Eq><FieldRef Name="DTMID" LookupId="TRUE" /><Value Type="Lookup">' + dtmid + '</Value></Eq></Where></Query></View>');
        ...
        function onQuerySucceeded2() {
            //	alert('DTM Deliverables and CheckPoints are updated successfully');
            waitDialog.close(0);
            window.location.href = "http://sharepoint/sites/ProjectQualityRoom/Lists/DTMConfig/DTMResults.aspx?ID=" + dtmid + "&Source=" + source;
    ...
    function GBLogic() {
        ...
        var pname = $("select[id*=ff641_ctl00_Lookup] option:selected").text();
